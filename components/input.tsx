...
export function InputIcon(props: InputIconProps) {
	return (
		// group permite que quando o grupo tiver uma propriedade desejada, essa propriedade e aplicada tambem a outro elemento
		// [] -> permite adicionar propriedades do CSS; & -> referencia ele mesmo (a div)
		<span
